...
export default function CreateCampaignModule() {
    ...
    const handlePublishNow = async () => {
        ...
        try {
            ...
            if (res.success) {
                ...
                showToast(res.message || 'Failed to publish campaign', 'error');
            }
        } catch (error) {
                        ...
                        <form onSubmit={handleSubmit} className="card border-0 shadow-sm rounded-4 overflow-hidden">
                                    ...
                                    <div className="col-12">
                                        ...
                                        <div className="row g-3">
                                            <div className="col-md-6">
                                                <div
                                                    className={`p-4 rounded-4 border-2 cursor-pointer transition-all ${formData.scheduleMode === 'one-time' ? 'border-primary bg-light' : 'bg-light opacity-75'}`}
                                                ...
                                                >
                                                    <div className="d-flex align-items-center gap-3">
                                                        ...
                                                        <div>
                                                            <div className="fw-bold">One-time Post</div>
                                            ...
                                            <div className="col-md-6">
                                                <div
                                                    className={`p-4 rounded-4 border-2 cursor-pointer transition-all ${formData.scheduleMode === 'recurring' ? 'border-primary bg-light' : 'bg-light opacity-75'}`}
                                    ...
                                    <div className="col-12">
                                        <div className="card border-0 shadow-sm bg-dark rounded-4 p-4 text-white">
                                            <div className="d-flex align-items-center gap-3 mb-4">
                                                ...
                                                <h5 className="fw-bold mb-0 text-white">Marketing & Sales Booster</h5>
                                            </div>
                            ...
                            <div className="card-footer bg-light border-0 p-4 p-md-5 d-flex flex-column flex-md-row justify-content-end gap-2">
                                ...
                                <button
                                    ...
                                    disabled={loading}
                                    className="btn btn-outline-primary rounded-pill px-5 order-2 order-md-3"
                                >
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="btn btn-primary rounded-pill px-5 order-1 order-md-4 shadow-sm"
                                >
