...
export default function EditCampaignModule() {
    ...
    const loadInitialData = async () => {
        try {
            ...
            showToast('An error occurred while loading campaign data', 'error');
        } finally {
            setFetching(false);
        }
    };
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            if (res.success) {
                ...
                setTimeout(() => navigateTo(`/social/campaigns/${id}`), 1500);
            } else {
                showToast(res.message || 'Failed to update campaign', 'error');
            }
        } catch (error) {
