...
interface DealPreventionProps {
    mode: string;
}

export default function DealPrevention({ mode }: DealPreventionProps) {
                                            ...
                                            <table className="table table-hover align-middle mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    {highRiskDeals.length === 0 && (
                                                        <tr>
                                                            <td colSpan={5} className="text-center py-4 text-muted">No high-risk deals detected yet. Good job!</td>
                                                        </tr>
                                                    )}
                                                </tbody>
                                            </table>
