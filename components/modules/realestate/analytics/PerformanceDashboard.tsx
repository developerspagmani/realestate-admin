...
export default function PerformanceDashboard({ adminPrefix }: PerformanceDashboardProps) {
        ...
        <ModuleGuard moduleSlug="analytics_pro">
            <MainLayout activePage="analytics">
                <div className="container-fluid py-4">
                    ...
                    <div className="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div className="d-flex gap-2">
                            <Link href={`${adminPrefix}/analytics/forecasting`} className="btn btn-primary rounded-3 shadow-sm">
                                                    ...
                                                    {agentPerformance.map((agent) => (
                                                        <tr key={agent.id}>
                                                            <td className="px-4 py-3">
                                                                <div className="d-flex align-items-center">
                                                                    <div className="bg-primary bg-opacity-10 text-primary rounded-circle p-2 me-3 fw-bold small" style={{ width: '32px', height: '32px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                                                        {agent.name.charAt(0)}
                                                                    </div>
                                                            ...
                                                            <td className="py-3">
                                                                <div className="d-flex align-items-center gap-2">
                                                                    <div className="progress rounded-pill flex-grow-1" style={{ height: '6px', maxWidth: '100px' }}>
                                                                        <div className="progress-bar bg-success" style={{ width: `${agent.conversionRate}%` }}></div>
                                                                    </div>
                                                                    <span className="extra-small fw-bold">{agent.conversionRate}%</span>
                                                                </div>
                                                            </td>
                                                            <td className="px-4 py-3 text-end fw-bold text-dark">${agent.revenue.toLocaleString()}</td>
                                                        </tr>
                                                    ))}
                                                </tbody>
                                            </table>
                ...
                <style jsx>{`
                    ...
                    .hvr-translate-x:hover { transform: translateX(5px); }
                    .hvr-scale-sm:hover { transform: scale(1.02); }
