...
export default function DashboardStats({ mode, stats, loading }: DashboardStatsProps) {
            ...
            <>
                ...
                <div className="row g-4 mb-4">
                    <div className="col-md-3">
                        <StatCard label="Total Owners" value={stats.totalOwners} subLabel="Space owners" icon="bi-people" color="primary" bgClass="bg-primary text-white" />
                    </div>
                    <div className="col-md-3">
                        <StatCard label="Total Spaces" value={stats.totalProperties} subLabel="Managed properties" icon="bi-building" color="success" bgClass="bg-success text-white" />
                    </div>
                    <div className="col-md-3">
                        <StatCard label="Workspaces" value={stats.totalUnits} subLabel="Total units" icon="bi-laptop" color="info" bgClass="bg-info text-white" />
                    </div>
                    <div className="col-md-3">
                        <StatCard label="Users" value={stats.totalUsers} subLabel="Registered users" icon="bi-person" color="warning" bgClass="bg-warning text-dark" />
                    </div>
                </div>
                ...
                <div className="row g-4">
                    <div className="col-md-3">
                        <StatCard label="Total Bookings" value={stats.totalBookings} icon="bi-calendar-check" color="secondary" />
                    </div>
                    <div className="col-md-3">
                        <StatCard label="Available" value={stats.availableUnits} icon="bi-check-circle" color="success" />
                    </div>
                    <div className="col-md-3">
                ...
                {/* Admin Booking Status Row - Optional but requested in original file */}
                <div className="row g-4 mt-1">
                    <div className="col-md-6">
                        <div className="card border-0 shadow-sm bg-warning-subtle text-warning-emphasis">
                    ...
                    <div className="col-md-6">
                        <div className="card border-0 shadow-sm bg-success-subtle text-success-emphasis">
                            <div className="card-body p-4 d-flex justify-content-between align-items-center">
                                <div>
    ...
    return (
        <div className="row g-4 mb-4">
            <div className="col-md-3">
                <StatCard label="My Properties" value={stats.totalProperties} icon="bi-building" color="primary" />
            </div>
            <div className="col-md-3">
                <StatCard label="Total Units" value={stats.totalUnits} icon="bi-laptop" color="success" />
            </div>
            <div className="col-md-3">
