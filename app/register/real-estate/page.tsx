                                ...
                                {success ? (
                                    ...
                                    <>
                                        <div className="text-center mb-4">
                                            ...
                                            <h2 className="fw-bold text-dark">Real Estate Partner</h2>
                                            <p className="text-muted">Register your property management business</p>
                                        </div>
                                                ...
                                                <div className="col-md-6">
                                                    ...
                                                    <div className="input-group">
                                                        ...
                                                        <input
                                                            ...
                                                            onChange={handleChange}
                                                            placeholder="e.g. www.smithproperties.com"
                                                        />
                                                    </div>
                                                </div>
