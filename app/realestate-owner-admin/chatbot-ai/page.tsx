                        ...
                        <div className="d-flex align-items-center justify-content-between">
                            <div>
                                <h4 className="fw-bold mb-1 text-primary">
                                    <i className="bi bi-robot me-2"></i> Vipranix Neural Engine
                                </h4>
                                <p className="text-muted mb-0">Configure your organization's conversational AI, lead generation, and sales logic.</p>
                            </div>
                            <div className="d-flex gap-2">
                                <div className="badge bg-primary-soft text-primary px-3 py-2 rounded-pill">
                                    <i className="bi bi-cpu me-1"></i> Gemini 1.5 Flash Active
                                </div>
                                <div className="badge bg-success-soft text-success px-3 py-2 rounded-pill">
                                    <i className="bi bi-shield-check me-1"></i> Enterprise Ready
                                </div>
                            </div>
                        </div>
                    </div>
