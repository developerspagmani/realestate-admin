...
interface DemandSummary {
    ...
    avgBuyerBudget: number;
    avgListingPrice: number;
    uniqueKeywords: number;
    uniqueCitiesSearched: number;
}
                                ...
                                <div className="card-body p-0">
                                    <div className="table-responsive">
                                        <table className="table table-hover align-middle mb-0">
                                            ...
                                            <tbody>
                                                {data?.keywordShortages.map((item: ShortageItem, i: number) => (
                                                    <tr key={i}>
                                ...
                                <div className="card-body p-0">
                                    <div className="table-responsive">
                                        <table className="table table-hover align-middle mb-0">
                                            ...
                                            <tbody>
                                                {data?.featureShortages.map((item: ShortageItem, i: number) => (
                                                    <tr key={i}>
                                ...
                                <div className="card-body p-0">
                                    <div className="table-responsive">
                                        <table className="table table-hover align-middle mb-0">
                                            ...
                                            <tbody>
                                                {data?.cityShortages.map((item: ShortageItem, i: number) => (
                                                    <tr key={i}>
